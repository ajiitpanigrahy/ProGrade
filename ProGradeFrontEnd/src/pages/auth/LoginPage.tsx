        ...
        >
            ...
            <div className="bg-white dark:bg-[#1a0d36] py-8 px-6 shadow-xl sm:rounded-2xl border border-gray-100 dark:border-purple-900/30 transition-colors duration-300">
                <form className="space-y-6" onSubmit={handleLogin}>
                    ...
                    {error && (
                        <div className="p-3 text-sm text-red-500 bg-red-50 dark:bg-red-950/30 border border-red-200 dark:border-red-900/50 rounded-xl transition-colors">
                            {error}
                        </div>
                    )}
                    ...
                    <div>
                        <button
                            type="submit"
                            disabled={isLoading}
                            className="cursor-pointer w-full flex justify-center py-3 px-4 border border-transparent rounded-xl shadow-sm text-sm font-bold text-white bg-purple-600 hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-600 transition-all active:scale-[0.98] disabled:opacity-50"
                        >
                ...
                <div className="mt-8">
                    <div className="relative">
                        <div className="absolute inset-0 flex items-center">
                            <div className="w-full border-t border-gray-200 dark:border-purple-900/30" />
                        </div>
                        <div className="relative flex justify-center text-sm">
                            <span className="px-3 bg-white dark:bg-[#1a0d36] text-gray-500 dark:text-gray-400 font-medium transition-colors">Or continue with</span>
                        </div>
                    </div>
                    ...
                    <div className="mt-6 grid grid-cols-2 gap-4">
                        <button
                            type="button"
                            className="cursor-pointer w-full inline-flex justify-center py-2.5 px-4 border border-gray-200 dark:border-purple-900/50 rounded-xl shadow-sm bg-white dark:bg-[#0f0a1c] text-sm font-medium text-gray-500 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-[#150a29] hover:text-gray-900 dark:hover:text-white transition-all active:scale-[0.98]"
                        >
